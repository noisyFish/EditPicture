...
public class MosaicViewGood extends ViewGroup implements ScaleGestureDetector.OnScaleGestureListener{
	...
	public MosaicViewGood(Context context) {
		this(context, null);
	}

	public MosaicViewGood(Context context, AttributeSet attrs) {
		super(context, attrs);
		initImage();
